...
FS.SoundCollection.getSoundsFromQuery = function(query, page, filter, sort, type, succesCallback, errorCallback){
        ...
        function(inProperties)
        {
                ...
                //call succesCallback method    
                if($.isFunction(succesCallback)){succesCallback(newSoundCollection,type); };
        }, errorCallback, params);
}
